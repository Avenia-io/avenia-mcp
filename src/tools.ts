...
export const TOOLS: readonly ToolDefinition[] = [
  ...
  },
  {
    ...
    "method": "PATCH",
    "pathTemplate": "/v2/auth/change-password",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
  ...
  {
    "name": "avenia_confirm_remove_mfa_totp",
    "description": "Confirm Remove MFA TOTP",
    "inputSchema": {
      "type": "object",
      "properties": {
        "body": {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/mfa/totp/remove/confirm",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
  ...
  {
    "name": "avenia_create_mfa_totp",
    "description": "Create MFA TOTP",
    "inputSchema": {
      "type": "object",
      "properties": {},
      "additionalProperties": false
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/mfa/totp/create",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": false,
    "skipAuth": false
  ...
  },
  {
    ...
    "method": "DELETE",
    "pathTemplate": "/v2/auth/accesses/{access-id}",
    "pathParams": [
      "access-id"
    ],
    "queryParams": [
  ...
  },
  {
    ...
    "method": "DELETE",
    "pathTemplate": "/v2/auth/api-keys/{api-key}",
    "pathParams": [
      "api-key"
    ],
    "queryParams": [
  ...
  },
  {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/forgot-password",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "createdAfter": {
          "type": "integer",
          "description": "Filter accesses created after timestamp"
        },
        "createdBefore": {
          "type": "integer",
          "description": "Filter accesses created before timestamp"
        },
        "email": {
          "type": "string",
        ...
        "payIn": {
          "type": "string",
          "description": "Filter by payIn permission"
        },
        "payOut": {
          "type": "string",
          "description": "Filter by payOut permission"
        },
        "convert": {
          "type": "string",
          "description": "Filter by convert permission"
        },
        "onChain": {
          "type": "string",
          "description": "Filter by onChain permission"
        },
        "viewOnly": {
          "type": "string",
          "description": "Filter by viewOnly permission"
        }
      },
      "additionalProperties": false
    },
  ...
  {
    "name": "avenia_remove_mfa_totp",
    "description": "Remove MFA TOTP",
    "inputSchema": {
      "type": "object",
      "properties": {},
      "additionalProperties": false
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/mfa/totp/remove",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": false,
    "skipAuth": false
  },
  {
    ...
    "method": "PATCH",
    "pathTemplate": "/v2/auth/reset-password/{reset-token}",
    "pathParams": [
      "reset-token"
    ],
    "queryParams": [],
  ...
  {
    "name": "avenia_update_access_permissions",
  ...
  },
  {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/accesses/validate/{validate-token}",
    "pathParams": [
      "validate-token"
    ],
    "queryParams": [],
  ...
  {
    "name": "avenia_validate_login_step_2",
    "description": "Validate Login (Step 2)",
    "inputSchema": {
      "type": "object",
      "properties": {
        "body": {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/validate-login",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
  ...
  {
    "name": "avenia_validate_mfa_totp",
    "description": "Validate MFA TOTP",
    "inputSchema": {
      "type": "object",
      "properties": {
        "body": {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/mfa/totp/validate",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
  ...
  {
    "name": "avenia_verify_email_existence",
    "description": "Verify Email Existence",
    "inputSchema": {
      "type": "object",
      "properties": {
        "body": {
    ...
    "method": "POST",
    "pathTemplate": "/v2/auth/verify-existence",
    "pathParams": [],
    "queryParams": [],
    "bodyUnwrap": true,
    "skipAuth": false
